/** @file
  ...
  Uses AL HAL for NAND controller access. Supports Toshiba BENAND
  (built-in ECC) flash as a read-only block device.
...
//
// Toshiba BENAND: ID byte 5 (0-indexed byte 4) bit 7 indicates BENAND
//
